...
while True:
    ...
    if len(posList) != 0:
        ...
        finger_mcp = [5,9,13,17] #bottom of the finger
        finger_dip = [6,10,14,18]
        finger_pip = [7,11,15,19]
        finger_tip = [8,12,16,20] #tip of the finger
        ...
        if(fingers.count(0)==4): 
            result="YES"
        elif(fingers.count(0)==0): 
            result="STOP"
        elif(fingers.count(0)==3): 
            result="1"
        elif(fingers.count(0)==2): 
            result="2"
        elif(fingers.count(0)==1): 
            result="3"       
        elif(fingers[1]==0 and fingers[2]==0 and fingers[0]==1 and fingers[3]==1):
            result="@"
        elif result=="":
            print("error")
        else:
